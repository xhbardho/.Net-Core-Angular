...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            if (userParams.MinAge != 18 || userParams.MaxAge != 19) 
            {
        ...
        {
            var message = _context.Message.Include(u => u.Sender).ThenInclude(p => p.Photos)
        ...
        {
            var message = await _context.Message.Include(u => u.Sender).ThenInclude(p => p.Photos)
              .Include(u => u.Recipient).ThenInclude(p => p.Photos)
